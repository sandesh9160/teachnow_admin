    ...
    <div className="space-y-4 pb-6 antialiased animate-fade-in-up">
      ...
      <div className="relative group">
        ...
        <input 
          ...
          className="w-full pl-11 pr-6 py-2 bg-white border border-slate-200 rounded-xl text-xs font-medium text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary/20 transition-all" 
        />
      </div>
          ...
          <table className="w-full text-left border-collapse min-w-[1000px]">
            <thead>
              <tr className="border-b border-slate-200 bg-slate-50/50">
                <th className="px-4 py-2.5 text-xs font-medium text-slate-500 whitespace-nowrap">Reviewer</th>
                <th className="px-4 py-2.5 text-xs font-medium text-slate-500 whitespace-nowrap">Feedback</th>
                <th className="px-4 py-2.5 text-xs font-medium text-slate-500 whitespace-nowrap text-center">Rating</th>
                <th className="px-4 py-2.5 text-xs font-medium text-slate-500 whitespace-nowrap text-center">Status</th>
                <th className="px-4 py-2.5 text-xs font-medium text-slate-500 whitespace-nowrap text-right">Date</th>
                  ...
                  <tr key={row.id} className="group hover:bg-slate-50/80 transition-all duration-200">
                    <td className="px-4 py-2.5">
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 rounded bg-slate-100 border border-slate-200 flex items-center justify-center shrink-0 overflow-hidden group-hover:scale-105 transition-transform">
                          {row.photo ? (
                        ...
                        <div className="min-w-0">
                          <p className="text-xs font-medium text-slate-900 group-hover:text-primary transition-colors truncate">{row.name}</p>
                    ...
                    >
                      <button
                        ...
                        className={clsx(
                          "inline-flex items-center px-2 py-0.5 rounded text-[10px] font-medium border transition-all active:scale-95 cursor-pointer relative z-30",
                          isActive 
                    ...
                    <td className="px-4 py-2.5 text-right text-[11px] text-slate-500 whitespace-nowrap">
