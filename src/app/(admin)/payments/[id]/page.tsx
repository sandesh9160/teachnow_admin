          ...
          <div className="flex items-center gap-3">
              ...
              <div>
                  <div className="flex items-center gap-2 mb-0.5">
                      <span className="text-[9px] font-bold text-indigo-600 bg-indigo-50 px-1.5 py-0.5 rounded border border-indigo-100">Payment history</span>
                      <span className="w-1 h-1 rounded-full bg-slate-300" />
                      <span className="text-[9px] font-bold text-indigo-900">#{payment.transaction_id}</span>
                  </div>
                  <h1 className="text-xl font-semibold leading-none">Transaction Details</h1>
              </div>
          </div>
        ...
        <div className="lg:col-span-8 space-y-8">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                {[
                    ...
                    { label: "Total Paid", value: `₹${Number(payment.amount).toLocaleString()}`, icon: Zap, color: "text-indigo-600", bg: "bg-indigo-50" },
                    ...
                    <div key={i} className="bg-white p-3 rounded-xl border border-slate-200/60 shadow-sm flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-[9px] font-bold text-indigo-900 leading-none mb-1">{stat.label}</p>
                            <p className={clsx("text-[13px] font-bold capitalize tracking-tight", stat.color)}>{stat.value}</p>
                        </div>
                    </div>
                ))}
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200/60 shadow-xl shadow-slate-900/5 overflow-hidden">
                <div className="px-5 py-4 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1.5 px-2 py-0.5 bg-white border border-slate-200 rounded-md text-[9px] font-bold text-indigo-600">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6">
                        ...
                        <div className="flex-1 space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12">
                                <div>
                                    <p className="text-[10px] font-bold text-indigo-900 mb-1.5">Legal name</p>
                                    <h4 className="text-lg font-bold text-slate-900">{employer.name}</h4>
                                </div>
                                <div>
                                    <p className="text-[10px] font-bold text-indigo-900 mb-1.5">Payment method</p>
                                    <div className="flex items-center gap-2">
                                ...
                                <div>
                                    <p className="text-[10px] font-bold text-indigo-900 mb-1.5">Email contact</p>
                                    <p className="text-[13px] font-bold text-slate-700 flex items-center gap-2">
                                        <Mail size={14} className="text-indigo-600/50" />
                                        {employer.email}
                                    </p>
                                </div>
                                <div>
                                    <p className="text-[10px] font-bold text-indigo-900 mb-1.5">Phone number</p>
                                    <p className="text-[13px] font-bold text-slate-700 flex items-center gap-2">
                                ...
                                <div className="md:col-span-2 pt-4 border-t border-slate-100">
                                    <p className="text-[10px] font-bold text-indigo-900 mb-2">Registered address</p>
                                    <p className="text-[13px] font-medium text-slate-700 flex items-start gap-2 leading-relaxed">
                                        <MapPin size={14} className="text-indigo-600/50 shrink-0 mt-0.5" />
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-4 flex items-center justify-between shadow-sm">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h4 className="text-slate-900 font-bold text-[12px]">Payment Security</h4>
                        <p className="text-slate-600 text-[10px] font-medium">Verified by system on {new Date().toLocaleDateString()}</p>
                    </div>
                </div>
                <div className="hidden sm:flex items-center gap-2 px-3 py-1 bg-emerald-50 rounded-lg border border-emerald-100 text-emerald-700 text-[9px] font-bold">
                ...
                <div className="px-5 py-4 border-b border-slate-100 bg-indigo-600 text-white relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center justify-between mb-2">
                            <span className="text-[8px] font-bold text-indigo-200">Current plan</span>
                            <span className="px-1.5 py-0.5 bg-white/20 backdrop-blur-md rounded text-[8px] font-bold">
                                {subscription.status}
                            </span>
                        </div>
                        <h3 className="text-xl font-bold tracking-tight">{subscription.plan_name}</h3>
                    </div>
                </div>
                ...
                <div className="p-5 flex-1 space-y-5">
                    <div className="space-y-3">
                        <div>
                            <div className="flex justify-between items-end mb-1">
                                <p className="text-[9px] font-bold text-indigo-900">Job posts</p>
                                <p className="text-[12px] font-bold text-slate-900">{subscription.job_posts_used} / {subscription.job_posts_total}</p>
                            </div>
                        ...
                        <div>
                            <div className="flex justify-between items-end mb-1">
                                <p className="text-[9px] font-bold text-indigo-900">Featured jobs</p>
                                <p className="text-[12px] font-bold text-slate-900">{subscription.featured_jobs_used} / {subscription.featured_jobs_total}</p>
                            </div>
                            <div className="w-full h-1 bg-slate-100 rounded-full overflow-hidden">
                                <div 
                    ...
                    <div className="pt-4 border-t border-slate-100 space-y-2">
                        <div className="flex items-center justify-between">
                            <span className="text-[10px] font-bold text-indigo-900">Valid from</span>
                            <span className="text-[11px] font-bold text-slate-900">{new Date(subscription.starts_at).toLocaleDateString()}</span>
                        </div>
                        <div className="flex items-center justify-between">
                            <span className="text-[10px] font-bold text-indigo-900">Ends on</span>
                ...
                <div className="p-4 bg-slate-50 border-t border-slate-100">
                    <div className="flex items-center gap-3 p-3 bg-white rounded-xl border border-slate-200 shadow-sm mb-3">
                        ...
                        <div className="flex-1 overflow-hidden">
                            ...
                            <p className="text-[9px] text-indigo-600 font-bold">{invoice.invoice_date}</p>
                        </div>
                        <a 
                            href={invoice.pdf_url}
                            target="_blank"
