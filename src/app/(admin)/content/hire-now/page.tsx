...
export default function HireNowPageContent() {
  ...
  const handleSaveMeta = async () => {
    setSavingMeta(true);
    // TODO: call API to save SEO meta for Hire Now page
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-4 pb-20 antialiased pt-2">
      ...
      <div className="flex items-center justify-between gap-4 px-2">
        <div>
            <h2 className="text-lg font-bold text-slate-900 tracking-tight">Hire Now</h2>
            <p className="text-[11px] font-medium text-slate-500 mt-0.5">Manage meta tags for the Hire Now landing page</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-md border border-[#cbd5e1] overflow-hidden">
        <div className="bg-white px-5 py-4 border-b border-[#cbd5e1] flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-600 font-medium mt-0.5">Manage search engine visibility for the Hire Now page</p>
            </div>
          </div>
          <button
        ...
        <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="md:col-span-2 space-y-2">
            ...
            <input
              suppressHydrationWarning
              id="hire-now-meta-title"
              type="text"
              placeholder="e.g. Hire Now | TeachNow — Connect with Top Teaching Talent"
          ...
          <div className="md:col-span-2 space-y-2">
            ...
            <textarea
              suppressHydrationWarning
              id="hire-now-meta-description"
              rows={3}
              placeholder="e.g. Need to fill a teaching position fast? Post a job on TeachNow and connect with qualified educators immediately. Start hiring today."
          ...
          <div className="md:col-span-2 space-y-2">
            ...
            <input
              suppressHydrationWarning
              id="hire-now-meta-keywords"
              type="text"
              placeholder="e.g. hire teachers, post teaching jobs, school recruitment, teachnow employers"
