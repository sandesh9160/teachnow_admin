...
export default function DeletedCVTemplatesPage() {
  ...
  const handlePermanentDelete = async (id: number) => {
    if (!confirm("Are you sure you want to permanently delete this CV?")) return;
    try {
  ...
  return (
    <div className="space-y-6 pb-12 antialiased">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-surface-900 tracking-tight">Deleted templates</h1>
          <p className="text-[13px] text-surface-400 font-medium italic">Removed resume designs</p>
        </div>
      </div>
